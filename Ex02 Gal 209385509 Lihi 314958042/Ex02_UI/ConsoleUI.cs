...
namespace Ex02_UI
{
    public class ConsoleUI
    {
        ...
        private void printRoundResult()
        {
            ...
            int leftPaddingTotalLength = calculateLeftPadding(roundEndMessage);
        ...
        private int calculateLeftPadding(string i_OutputMessage)
        {
            int screenWidth = 2 + (r_Game.BoardSize * 4);
            
            return (screenWidth / 2) + (i_OutputMessage.Length / 2);
        }
        ...
        public ConsoleUI(string i_QuitSymbol, int i_BoardSize, bool i_IsVsComputer)
        {
            r_Quit = i_QuitSymbol;
